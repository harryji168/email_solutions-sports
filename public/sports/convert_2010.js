...
const jsCode = fs.readFileSync('scratch_7m_2010_matches.js', 'utf-8');
...
fs.writeFileSync('leagues/FIFA_2010.json', JSON.stringify(matches, null, 2));
console.log('Successfully created leagues/FIFA_2010.json');
